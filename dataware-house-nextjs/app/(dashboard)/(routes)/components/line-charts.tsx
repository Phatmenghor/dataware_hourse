...
export const LineCharts: React.FC<ChartsProps> = ({
  title,
  code,
  widgetId,
}) => {
  ...
  useEffect(() => {
    ...
    console.log(query);
    getInitData();
  }, [branch, fromDate, toDate, months, reportDate, paramSize, query]);
  ...
  return (
    <div className="bg-white p-3 rounded-md w-full">
      ...
      <div className="grid grid-cols-2 gap-8">
        ...
        <div className="flex h-[300px] mx-2">
          <Line
            data={{
              labels: labels,
              datasets: [
